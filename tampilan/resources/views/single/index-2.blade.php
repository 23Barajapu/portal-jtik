...
@section('content')
  <main>
    <!-- ================= Banner section start ================= -->
        <section class="vl-hero-area p-relative fix z-index-1 pt-200 pb-70"
            style="background-image: url(/img/banner/vl-home-bg-2.png);">
      ...
      <div class="col-xl-6 mb-30">
        ...
        <div class="vl-section-title-wrapper">
          <h4 class="vl-section-subtitle-2 fw-500">Top #1 It Service & Technology</h4>
                                <h1 class="vl-section-heading vl-white pt-16">Future-Proof Your Business With Best Expert IT
                                    Solutions</h1>
        ...
        <div class="vl-hero-btn">
                                <a href="{{ route('second', ['pages', 'contact']) }}" class="them-btn2 fix mr-16">Explore
                                    Solutions <span><i class="fa-regular fa-angle-right"></i></span></a>
                                <a href="{{ route('second', ['pages', 'contact']) }}" class="theme-sec-btn2">Contact
                                    Us<span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="col-lg-6 mb-30">
                        <div class="vl-about-imgs-2 p-relative mr-60 aos-init aos-animate" data-aos="fade-right"
      ...
      <div class="col-lg-6 mb-30">
        ...
        <div class="vl-section-title-wrapper">
          <h4 class="vl-section-subtitle-black-border">About Us</h4>
                                <h2 class="vl-section-title vl-black-theme-2 pt-16 pb-20">Redefining IT Services<br /> with
                                    Passion and Purpose</h2>
        ...
        <div class="vl-about-btn">
                                <a href="{{ route('second', ['pages', 'about']) }}" class="them-btn2">See my
                                    experience<span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
        </div>
      </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="vl-section-title-wrapper mb-60">
        <h4 class="vl-section-subtitle-black-border">Our Service</h4>
                        <h2 class="vl-section-title vl-black-theme-2 pt-16">Comprehensive IT Solutions <br /> for Every Need
                        </h2>
      </div>
      </div>
      <div class="row">
      ...
      <div class="col-lg-7 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
        ...
        <p class="pt-16 pb-24">
                                Keep your business running with reliable and optimized IT infrastructure <br /> We provide
                                end-to-end infrastructure management, from network design.
        </p>
                            <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More <span><i
      ...
      <div class="col-lg-5 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1200">
        ...
        <div class="vl-service-icon vl-service-icon-2">
          <span><img src="/img/icons/vl-service-ic-2.2.svg" alt="" /></span>
                            ...
                            <h2 class="vl-service-title pt-32"><a
                                    href="{{ route('second', ['services', 'single']) }}">Software Development</a></h2>
                            <p class="pt-16 pb-24">Transform your ideas into reality with our custom software development
                                service whether you need.</p>
                            <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
      </div>
      <!-- single service box end -->
      ...
      <div class="col-lg-5 mb-30 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1400">
        ...
        <div class="vl-service-icon vl-service-icon-2">
          <span><img src="/img/icons/vl-service-ic-2.3.svg" alt="" /></span>
                            ...
                            <h2 class="vl-service-title pt-32"><a
                                    href="{{ route('second', ['services', 'single']) }}">Cybersecurity Services</a></h2>
        <p class="pt-16 pb-24">
                                Protect your business from evolving cyber threats <br /> with our comprehensive
      ...
      <div class="col-lg-7 mb-30 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1600">
        ...
        <p class="pt-16 pb-24">
                                Navigate the complexities of technology with expert guidance from our IT <br /> consultants.
                                We help businesses strategize & implement the right solution.
        </p>
                            <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
    ...
    <div class="container">
      ...
      <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
        ...
        <div class="vl-gallery-testimonial-2-con">
                            <h3 class="vl-gallery-testimonial-2-title"><a
        ...
        <h3><a href="{{ route('second', ['case-study', 'single']) }}">Read More</a></h3>
                            <a href="{{ route('second', ['case-study', 'single']) }}"><span class="arow2"><i
      ...
      <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
        ...
        <div class="vl-gallery-testimonial-2-con">
                            <h3 class="vl-gallery-testimonial-2-title"><a
                                    href="{{ route('second', ['case-study', 'single']) }}">Building Resilient Networks</a>
                            </h3>
        </div>
        <div class="vl-gallery-poligon poligon2">
        <h3><a href="{{ route('second', ['case-study', 'single']) }}">Read More</a></h3>
      ...
      <div class="vl-gallery-testimonial-2 br-4 fix p-relative z-index-1">
        ...
        <div class="vl-gallery-testimonial-2-con">
                            <h3 class="vl-gallery-testimonial-2-title"><a
                                    href="{{ route('second', ['case-study', 'single']) }}">Seamless Cloud Migration</a>
                            </h3>
        </div>
        <div class="vl-gallery-poligon poligon2">
        <h3><a href="{{ route('second', ['case-study', 'single']) }}">Read More</a></h3>
          ...
          <div class="vl-test-icons">
            ...
            <li>
              <a href="#"><i class="fa-solid fa-star"></i></a>
                                    ...
                                    <p>“Our clients words speak volumes about impact of our services. We take pride in
                                        building strong best partnerships and delivering solutions that exceed expectations
                                        from seamless cloud migrations.”</p>
    ...
    <div class="container p-relative">
      ...
      <div class="col-lg-8">
        ...
        <h4 class="vl-section-subtitle-black-border">Our Team</h4>
                            <h2 class="vl-section-title vl-black-theme-2 pt-16">Dedicated Professionals,<br /> Proven
                                Results</h2>
        </div>
      </div>
      ...
      <div id="teamm2" class="owl-carousel owl-theme">
        ...
        <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a
                                        href="{{ route('second', ['pages', 'team']) }}">Kendra Cremin</a></h4>
        ...
        <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a
                                        href="{{ route('second', ['pages', 'team']) }}">Dennis Jacobson</a></h4>
        ...
        <div class="vl-team-single-content mt-20">
                                <h4 class="vl-team-single-title pb-16"><a
                                        href="{{ route('second', ['pages', 'team']) }}">Patricia Wilkinson</a></h4>
          <span>Network Engineer</span>
        </div>
        </div>
        <!-- single team end -->
    ...
    <div class="container">
      <div class="row align-items-center">
      <div class="col-lg-6">
                        <div class="vl-contact-box br-4 vl-white-bg mb-30 aos-init aos-animate" data-aos="fade-right"
                            data-aos-duration="900">
        <div class="vl-contact-box-content">
          <h3 class="vl-contact-box-title">Send us a Message</h3>
          <p class="off-w pt-20 pb-32 m-0">
                                    Have questions or need assistance? We're here to help! Whether <br /> you're exploring
        ...
        <div class="vl-contact-box-form-2">
          ...
          <div class="row">
            ...
            <div class="col-lg-12 mb-20">
            <div class="fl-right">
                                                <button class="them-btn2">Send Now <span><i
      ...
      <div class="col-lg-6">
                        <div class="vl-contact-wrap vl-contact-wrap-2 ml-80 mb-10 aos-init aos-animate"
    ...
    <div class="container">
      <div class="row">
      <div class="col-lg-5">
                        <div class="vl-blog-content-2 mb-30 aos-init aos-animate" data-aos="fade-right"
                            data-aos-duration="900">
        <div class="vl-section-title-wrapper">
          <h4 class="vl-section-subtitle-black-border">Our Recent Blog Post</h4>
                                <h2 class="vl-section-title vl-black-theme-2 pt-16 pb-20">Stay Informed with Our Recent
                                    Posts</h2>
          <p class="vl-section-description-2 pb-32">
                                    Our expert team works closely with you to understand <br /> your unique challenges and
                                    design strategies that<br /> propel your business forward into the future.
          </p>
        </div>
        <div class="vl-blog-btn">
                                <a href="{{ route('second', ['blogs', 'blog']) }}" class="them-btn2">read more blog
                                    <span><i class="fa-regular fa-angle-right"></i></span></a>
        </div>
        </div>
      </div>
      <div class="col-lg-7">
        ...
        <!-- single blog item -->
                            <div class="vl-single-blog-item vl-blg2 vl-gray-bg mb-30 aos-init aos-animate"
                                data-aos="fade-left" data-aos-duration="1100">
          <div class="row align-items-center">
          <div class="col-lg-5">
          ...
          <div class="col-lg-7">
            <div class="vl-single-blog-content vl-single-blog-content-2">
                                            <h3 class="vl-single-blog-title vl-black-theme-2"><a
                                                    href="{{ route('second', ['blogs', 'single']) }}">Your Trusted Partner
                                                    in <br /> Technology Transformation</a></h3>
            <p class="vl-single-blog-desc pt-10 pb-24">
                                                As your trusted partner, we take <br /> the time understand your business
          ...
          <div class="col-lg-7">
            <div class="vl-single-blog-content vl-single-blog-content-2">
                                            <h3 class="vl-single-blog-title vl-black-theme-2"><a
                                                    ...
                                                    Through <br /> Innovation and Collaboration</a></h3>
            <p class="vl-single-blog-desc pt-10 pb-24">
                                                We foster a culture of teamwork & <br /> creative problem-solving to deliver
    ...
    <div class="container">
      ...
      <div class="col-lg-4 col-md-6 mb-30">
        ...
        <div class="vl-footer-logo">
                                <a href="{{ route('any', 'index') }}"><img src="/img/logo/vl-logo-2.2.png"
                                        alt="" /></a>
        </div>
      ...
      <div class="col-lg-4 col-md-6 mb-30">
        ...
        <div class="vl-footer-newsletter vl-footer-newsletter-2">
          ...
          <div class="vl-footer-newsletter-btn-2 mt-16">
                                        <button class="w-100 them-btn2 btn-dot">Subscribe<span><i
                                                    class="fa-regular fa-angle-right"></i></span></button>
          </div>
          </form>
        </div>
