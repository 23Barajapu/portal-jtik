    ...
    <main>
                    ...
                    <div class="col-xl-6 mb-30">
                        <div class="vl-hero-content p-relative z-index-1">
                            ...
                            <div class="vl-section-title-wrapper">
                                ...
                                <h1 class="vl-section-heading vl-white pt-16">Innovative IT Service Best Solutions For A
                                    Smarter Future</h1>
                        ...
                        <div class="vl-hero-img p-relative">
                            <div class="vl-hero-circle">
                                <a href="#about">
                                    ...
                                    <img class="vl-hero-circle-icon-text" src="/img/shape/cl-text-circle.png"
                                        alt="" />
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-content aos-init aos-animate" data-aos="fade-left" data-aos-duration="1100">
                            <div class="vl-section-title-wrapper">
                                ...
                                <h2 class="vl-section-title vl-white pt-16 pb-20">Empowering Businesses One Solution at a
                                    Time</h2>
                                <p class="vl-section-description pb-32">
                                    Whether it optimizing IT infrastructure, enhancing <br /> cybersecurity, or driving
                                    digital transformation, we are <br /> committed to helping.
                                </p>
                            </div>
                            ...
                            <div class="vl-about-icon-box mb-30 d-flex">
                                ...
                                <div class="vl-about-icon-content">
                                    ...
                                    <p class="vl-about-icon-desc">
                                        We specialize in delivering tailored IT solutions<br /> empower businesses to thrive
                                        in the digital era. Our <br /> team experts brings deep industry knowledge,
                                        cutting-<br />edge tools.
                                    </p>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="vl-services text-center aos-init aos-animate" data-aos="fade-up" data-aos-duration="900">
                    <div class="vl-section-title-wrapper mb-60">
                        ...
                        <h2 class="vl-section-title vl-white pt-16">Transforming Businesses <br /> with Expert IT Services
                        </h2>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-7 mb-30">
                        <div class="vl-service-content aos-init aos-animate" data-aos="fade-left"
                            data-aos-duration="900">
                            <div class="vl-service-icon">
                                <span><img src="/img/icons/vl-service-1.2.svg" alt="" /></span>
                            </div>
                            <h2 class="vl-service-title1 pt-32"><a
                                    href="{{ route('second', ['services', 'single']) }}">Data Analytics & Business
                                    Intelligence</a></h2>
                            <p class="pt-16 pb-24">
                                Make informed decisions with actionable insights powered data <br /> analytics. Our Business
                                Intelligence (BI) solutions help you collect, <br />process, visualize.
                            </p>
                ...
                <div class="row flex-lg-row flex-column-reverse align-items-center">
                    <!-- single service box start -->
                    <div class="col-lg-7 mb-30">
                        <div class="vl-service-content aos-init aos-animate" data-aos="fade-right"
                            data-aos-duration="1000">
                            <div class="vl-service-icon">
                                <span><img src="/img/icons/vl-service-1.2.svg" alt="" /></span>
                            </div>
                            <h2 class="vl-service-title1 vl-white pt-32"><a
                                    href="{{ route('second', ['services', 'single']) }}">Software Development &
                                    Integration</a></h2>
                            <p class="pt-16 pb-24">
                                Bring your ideas to life with our custom software development services. <br />We design,
                                develop, & integrate software solutions tailored your<br /> business.
                            </p>
                            <div class="vl-service-redmore">
                                <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                    <span><i class="fa-regular fa-arrow-right"></i></span></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 mb-30">
                        <div class="vl-service-content aos-init aos-animate" data-aos="fade-left"
                            ...
                            <h2 class="vl-service-title1 vl-white pt-32"><a
                                    href="{{ route('second', ['services', 'single']) }}">Digital Transformation
                                    Services</a></h2>
                            <p class="pt-16 pb-24">
                                Stay ahead in a competitive market with digital transformation. <br />We help businesses
                                integrate the latest technologies to<br /> improve efficiency.
                            </p>
                            <div class="vl-service-redmore">
                                <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                    <span><i class="fa-regular fa-arrow-right"></i></span></a>
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-lg-7 col-md-6">
                                <div class="vl-gallery-item mb-30 aos-init aos-animate" data-aos="fade-up"
                                    data-aos-duration="900">
                                    <div class="vl-gallery-item-img">
                                        <img class="w-100" src="/img/studies/vl-studies-1.1.png" alt="" />
                                        <div class="vl-gallery-item-icon">
                                            <a href="{{ route('second', ['case-study', 'single']) }}"><img
                                                    src="/img/icons/vl-arrow-up.svg" alt="" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-gallery-item mb-30 aos-init aos-animate" data-aos="fade-up"
                            ...
                            <div class="vl-gallery-item-img vl-gallery-item-img-2">
                                <img class="vl-gallery-large w-100" src="/img/studies/vl-studies-1.5.png"
                                    alt="" />
                                <div class="vl-gallery-item-icon">
                                    <a href="{{ route('second', ['case-study', 'single']) }}"><img
                                            src="/img/icons/vl-arrow-up.svg" alt="" /></a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 mb-30">
                        <div class="vl-section-title-wrapper aos-init aos-animate" data-aos="fade-up"
                            data-aos-duration="900">
                            <h4 class="vl-section-subtitle vl-white vl-upper">Testimonial</h4>
                            <h2 class="vl-section-title vl-white pt-16 pb-32">Our Success Is A Measured By Are Satisfaction
                            </h2>
                            ...
                            <div class="vl-testimonial-active-5">
                                ...
                                <div class="vl-testimonial-box  p-relative br-8">
                                    ...
                                    <div class="vl-testimonial-box-content pt-20 pb-30">
                                        <p>
                                            “Their feedback fuel our passion <br />for continuous improvement and<br /> The
                                            innovation. We take immense pride in the relationships we’ve <br /> built and
                                            the trust we’ve earned through.”
                                        </p>
                                    </div>
                                    <div class="vl-testimonial-box-auth p-relative">
                                        ...
                                        <div class="vl-testimonial-box-auth-content">
                                            <h4 class="vl-testimonial-box-auth-title pb-10"><a
                                                    href="{{ route('second', ['pages', 'team']) }}">Ben Stokes</a></h4>
                                ...
                                <div class="vl-testimonial-box  p-relative br-8">
                                    ...
                                    <div class="vl-testimonial-box-content pt-20 pb-30">
                                        <p>
                                            “We believe that the true measure <br /> of success lies in the satisfaction &
                                            trust of our clients. Their stories of growth and transformation inspire <br />
                                            us to deliver excellence every <br /> step.”
                                        </p>
                                    </div>
                                    <div class="vl-testimonial-box-auth p-relative">
                                        <div class="vl-testimonial-box-auth-img">
                                        ...
                                        <div class="vl-testimonial-box-auth-content">
                                            <h4 class="vl-testimonial-box-auth-title pb-10"><a
                                                    href="{{ route('second', ['pages', 'team']) }}">Tim Ferguson</a></h4>
        ...
        <section id="work" class="vl-success p-relative z-index-1 vl-black-bg pt-100 pb-70">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-success-box text-center mb-30 aos-init aos-animate" data-aos="fade-up"
                            data-aos-duration="1000">
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title title4 vl-white pt-24 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Small & Medium Businesses</a>
                                </h3>
                                <p>
                                    Whether it’s cloud computing,<br /> cybersecurity, or IT consulting, we <br />help small
                                    & medium businesses.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-success-box text-center mb-30 aos-init aos-animate" data-aos="fade-up"
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title title4 vl-white pt-24 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Enterprises &
                                        Corporations</a></h3>
                                <p>
                                    Our tailored IT services—ranging <br />from infrastructure management <br />to advanced
                                    analytics support.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-success-box text-center mb-30 aos-init aos-animate" data-aos="fade-up"
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title title4 vl-white pt-24 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Financial Services &
                                        Banks</a></h3>
                                <p>
                                    In the financial sector, security <br /> and efficiency are paramount. Our <br /> IT
                                    services help banks & financial.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section id="blog" class="vl-blog vl-comn-black p-relative z-index-1 fix pt-100 pb-70">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="vl-section-title-wrapper mb-30 aos-init aos-animate" data-aos="fade-right"
                            data-aos-duration="900">
                            ...
                            <p class="vl-section-title-wrapper-description pb-32">
                                Our expert team works closely with you to <br />understand your unique challenges and design
                                <br /> strategies that propel your business forward into the <br /> future.
                            </p>
                    ...
                    <div class="col-lg-7">
                        <div class="vl-single-blog ml-60">
                            <!-- single blog item -->
                            <div class="vl-single-blog-item vl-single-blog-content-7 vl-comn-black-2 mb-30 aos-init aos-animate"
                                data-aos="fade-left" data-aos-duration="900">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="vl-single-blog-img fix br-8">
                                            <a href="{{ route('second', ['blogs', 'single']) }}"><img class="w-100"
                                                    src="/img/blog/vl-blog-1.1.png" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="vl-single-blog-content">
                                            <h3 class="vl-single-blog-title vl-white"><a
                                                    href="{{ route('second', ['blogs', 'single']) }}">Your Trusted Partner
                                                    in Technology Transformation</a></h3>
                                            <p class="vl-single-blog-desc pt-10 pb-24">As your trusted partner, we take the
                                                time understand your business objectives and challenges.</p>
                                            <a href="{{ route('second', ['blogs', 'single']) }}" class="vl-readmore">Read
                                                More <span class="rot-minus"><i
                            ...
                            <div class="vl-single-blog-item vl-single-blog-content-7 vl-comn-black-2 mb-30 aos-init aos-animate"
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="vl-single-blog-img fix br-8">
                                            <a href="{{ route('second', ['blogs', 'single']) }}"><img class="w-100"
                                                    src="/img/blog/vl-blog-1.2.png" alt="" /></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="vl-single-blog-content">
                                            <h3 class="vl-single-blog-title vl-white"><a
                                                    href="{{ route('second', ['blogs', 'single']) }}">Driving Success
                                                    Through Innovation and Collaboration</a></h3>
                                            <p class="vl-single-blog-desc pt-10 pb-24">We foster a culture of teamwork &
                                                creative problem-solving to deliver exceptional results for our clients.</p>
                                            <a href="{{ route('second', ['blogs', 'single']) }}"
                                                class="vl-readmore rot-minus">Read More <span class="rot-minus"><i
                                                        class="fa-regular fa-angle-right"></i></span></a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-l mx-auto">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="vl-contact-map mb-30 aos-init aos-animate" data-aos="fade-right"
                                    data-aos-duration="900">
                                    <iframe
                                        ...
                                        class="vl-contact-map" allowfullscreen=""></iframe>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="vl-contact-wrap mb-30 aos-init aos-animate" data-aos="fade-left"
                                    data-aos-duration="900">
                                    <div class="vl-section-title-wrapper">
                                        <h4 class="vl-section-subtitle vl-white vl-upper">Contact us</h4>
                                        <h2 class="vl-section-title vl-white pt-16 pb-32">Let’s Build Something Great
                                            Together</h2>
                                        ...
                                        <div class="vl-contact-wrap-icon-list">
                                            ...
                                            <div class="vl-contact-wrap-icon-box mb-24">
                                                <div class="vl-contact-wrap-icon">
                                                    <span><img src="/img/icons/vl-location-1.2.svg"
                                                            alt="" /></span>
                                                </div>
                                                <div class="vl-contact-wrap-text">
                                            ...
                                            <div class="vl-contact-wrap-icon-box mb-24">
                                                <div class="vl-contact-wrap-icon">
                                                    <span><img src="/img/icons/vl-envelop-1.3.svg"
                                                            alt="" /></span>
                                                </div>
                                                <div class="vl-contact-wrap-text">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="vl-footer-widget-1">
                                <div class="vl-footer-logo">
                                    <a href="{{ route('any', 'index') }}"><img src="/img/logo/vl-logo-1.1.png"
                                            alt="" /></a>
                                </div>
