...
@section('content')
    <main>
        ...
        <section class="vl-hero-area vl-hero-bg p-relative fix z-index-1 pt-234 pb-100"
            style="background-image: url(/img/banner/vl-hero-bg-3.png);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 mb-30">
                        <div class="vl-hero-content p-relative z-index-1">
                            <div class="vl-section-title-wrapper">
                                <h4 class="vl-section-subtitle-3 vl-theme-color-3 vl-upper vl-fs-16 m-0 br-50 vl-white">IT
                                    Solutions for a Smarter Future</h4>
                                <h1 class="vl-section-heading vl-white pt-16">Your Growth Powered By So Advanced IT Service
                                    Solutions</h1>
                                <p class="vl-section-description pt-16 pb-28">
                                    Empower your business with cutting technology solutions <br /> tailored to meet your
                                    unique needs from cloud computing.
                                </p>
                            </div>

                            <div class="vl-hero-btn-3">
                                <a href="" class="vl-btn-3">Book a Free Consultation<span><i
            ...
            <div class="container">
                <div class="row flex-lg-row flex-column-reverse align-items-center">
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-imgs vl-about-imgs-3 p-relative z-index-1 aos-init aos-animate"
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-about-content vl-about-content-3 aos-init aos-animate" data-aos="fade-left"
                            data-aos-duration="900">
                            <div class="vl-section-title-wrapper">
                                <h4 class="vl-section-subtitle-4 vl-fs-16 m-0 vl-theme-color3 vl-upper">About Us</h4>
                                <h2 class="vl-section-title vl-blc-text-4 pt-16 pb-20">Empowering Businesses <br /> One
                                    Solution at a Time</h2>
                                <p class="vl-section-description vl-section-description-3 pb-32">
                                    With a passion for solving complex challenges, we specialize in <br /> delivering
                                    tailored IT solutions that empower businesses thrive.
                                </p>
                            </div>
                            ...
                            <div class="vl-about-auth">
                                <div class="vl-about-authbtn">
                                    <a href="#" class="thme-btn3 mr-32">Get Started <span><i
                                                class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
        ...
        <section id="service" class="vl-service-area vl-gray-bg-2 pt-100 pb-70">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up"
                    data-aos-duration="900">
                    <h4 class="vl-section-subtitle-4 vl-fs-16 m-0 vl-theme-color3 vl-upper">Our Service</h4>
                    <h2 class="vl-section-title vl-blc-text-4 pt-16 pb-20">Transforming Businesses with <br /> Expert IT
                        Services</h2>
                </div>
                <div class="row">
                    <!-- single service box start -->
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-right"
                            data-aos-duration="900">
                            <div class="vl-service-icon icon3">
                                <span><img src="/img/icons/vl-service-ic-3.1.svg" alt="" /></span>
                            </div>
                            <h2 class="vl-service-title pt-32"><a href="{{ route('second', ['services', 'single']) }}">IT
                                    Consulting Services</a></h2>
                            <p class="pt-16 pb-24">
                                Navigate the complexities technology with expert guidance <br /> from our IT consultants. We
                                help businesses strategize.
                            </p>
                            <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                <span><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                    <!-- single service box end -->
                    <!-- single service box start -->
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-up"
                            ...
                            <p class="pt-16 pb-24">
                                Keep your business running smoothly with reliable optimized <br /> IT infrastructure we
                                provide end infrastructure management.
                            </p>
                            <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                <span><i class="fa-regular fa-arrow-right"></i></span></a>
                        </div>
                        ...
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-up"
                            ...
                            <div class="vl-df">
                                ...
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a
                                            href="{{ route('second', ['services', 'single']) }}">Cybersecurity Services</a>
                                    </h2>
                                    <p class="pt-16 pb-24">
                                        Protect your business from evolving cyber threats with our comprehensive
                                        cybersecurity solutions. From threat detection <br /> and response to data
                                        encryption and compliance management, we safeguard your digital 24/7.
                                    </p>
                                    <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                        <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-right"
                            ...
                            <div class="vl-df">
                                ...
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a
                                            href="{{ route('second', ['services', 'single']) }}">Cloud Solutions</a></h2>
                                    <p class="pt-16 pb-24">
                                        Leverage the power the cloud to streamline your <br /> operations boost scalability.
                                        Our cloud solutions <br />offer secure and flexible environments tailored.
                                    </p>
                                    <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                        <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
                    ...
                    <!-- single service box start -->
                    <div class="col-lg-6 mb-30">
                        <div class="vl-service-content vl-service-content-3 aos-init aos-animate" data-aos="fade-left"
                            ...
                            <div class="vl-df">
                                ...
                                <div class="vl-content">
                                    <h2 class="vl-service-title"><a
                                            href="{{ route('second', ['services', 'single']) }}">Software Development</a>
                                    </h2>
                                    <p class="pt-16 pb-24">
                                        Transform your ideas into reality with our custom <br /> software development
                                        services. Whether you <br /> need mobile apps, web platforms, or enterprise.
                                    </p>
                                    <a href="{{ route('second', ['services', 'single']) }}" class="vl-readmore">Learn More
                                        <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </div>
        ...
        <section id="case" class="vl-gallery2 p-relative z-index-1 pt-100 pb-100">
            <div class="container p-relative">
                <div class="vl-section-title-wrapper mb-60 aos-init aos-animate" data-aos="fade-up"
                    data-aos-duration="900">
                    ...
                    <div id="gallery3" class="owl-carousel owl-theme">
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a
                                            href="{{ route('second', ['case-study', 'single']) }}">Efficiency Managed IT
                                            Services</a></h3>
                                    <p>
                                        Our solutions ensure availability,<br /> minimal downtime, & improved.
                                    </p>
                                    <a href="{{ route('second', ['case-study', 'single']) }}" class="vl-readmore">Learn
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a
                                            href="{{ route('second', ['case-study', 'single']) }}">Fortifying
                                            Cybersecurity</a></h3>
                                    <p>
                        ...
                        <div class="vl-gallery-2 br-8 fix p-relative z-index-1">
                            ...
                            <div class="gallery-content fix">
                                <div class="gallery-content-trans">
                                    <h3 class="gallery-title pb-16"><a
                                            href="{{ route('second', ['case-study', 'single']) }}">Building Resilient
                                            Networks</a></h3>
                                    <p>
        ...
        <section id="testimonial" class="vl-testimonial vl-testimonial-bg pt-100 pb-100"
            style="background-image: url(/img/testimonial/vl-testimonial-bg-3.1.jpg);">
            <div class="container">
                <div class="vl-section-title-wrapper text-center mb-60 aos-init aos-animate" data-aos="fade-up"
                    data-aos-duration="900">
                    <h4 class="vl-section-subtitle-4 review-bg vl-white vl-fs-16 m-0 vl-theme-color3 vl-upper">Customer
                        Review</h4>
                            ...
                            <div class="vl-testimonial-active-4">
                                ...
                                <div class="vl-testimonial-box vl-testimonial-box-3 p-relative br-8">
                                    ...
                                    <div class="vl-testimonial-box-content text-center pt-20 pb-30">
                                        <p>
                                            “From seamless cloud migrations to enhanced cybersecurity, <br /> our work has
                                            helped businesses grow, adapt, and succeed in an ever-evolving digital
                                            landscape. But don't just take our word for hear directly those who have
                                    ...
                                    <div class="vl-testimonial-box-auth vl-testimonial-box-auth-3 p-relative">
                                        ...
                                        <div class="vl-testimonial-box-auth-content">
                                            <h4 class="vl-testimonial-box-auth-title pb-10"><a href="#">Ben
                                                    Stokes</a></h4>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate"
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Discovery & Planning</a></h3>
                                <p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate"
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Design & Development</a></h3>
                                <p>
                                    With a clear plan in place, our <br /> experts move into the design and <br />
                                    development phase.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate"
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Continuous Improvement</a>
                                </h3>
                                <p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="vl-success-box vl-success-box-3 text-center mb-30 aos-init aos-animate"
                            ...
                            <div class="vl-success-box-desc">
                                <h3 class="vl-success-box-title pt-32 pb-16"><a
                                        href="{{ route('second', ['services', 'single']) }}">Launch & Support</a></h3>
                                <p>
                                    Once everything is in place, we <br /> the solution with comprehensive <br />support but
                                    our work doesn’t.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="accordion" id="accordionExample">
                            ...
                            <div class="vl-accordion-item mb-20">
                                <h2 class="accordion-header" id="headingOne"><button class="accordion-button"
                                        ...
                                        aria-expanded="true" aria-controls="collapseOne">How long does it take to
                                        implement a solution?</button></h2>
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p>
                                            The implementation timeline varies depending on the complexity and scope of the
                                            <br /> project. We prioritize efficiency compromising quality & keep you
                                            informed.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="vl-accordion-item mb-20">
                                <h2 class="accordion-header" id="headingTwo"><button class="accordion-button collapsed"
                                        ...
                                        aria-expanded="false" aria-controls="collapseTwo">Can you customize solutions for
                                        my business?</button></h2>
                            ...
                            <div class="vl-accordion-item mb-20">
                                <h2 class="accordion-header" id="headingThree"><button class="accordion-button collapsed"
                                        ...
                                        aria-expanded="false" aria-controls="collapseThree">Do you offer ongoing support
                                        and maintenance?</button></h2>
                            ...
                            <div class="vl-accordion-item mb-20">
                                <h2 class="accordion-header" id="heading4"><button class="accordion-button collapsed"
                                        ...
                                        aria-expanded="false" aria-controls="collapse4">What if we already have an
                                        in-house IT team?</button></h2>
                            ...
                            <div class="vl-accordion-item mb-20">
                                <h2 class="accordion-header" id="heading5"><button class="accordion-button collapsed"
                                        ...
                                        aria-expanded="false" aria-controls="collapse5">What industries do you
                                        serve?</button></h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate"
                            data-aos="fade-right" data-aos-duration="900">
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="{{ route('second', ['blogs', 'single']) }}"><img class="br-8 w-100"
                                        src="/img/blog/vl-blog-3.1.png" alt="" /></a>
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a
                                        href="{{ route('second', ['blogs', 'single']) }}">Revolutionize Your Operations
                                        <br /> with Our Expertise</a></h3>
                                <a href="{{ route('second', ['blogs', 'single']) }}" class="vl-readmore more3">Learn More
                                    <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate"
                            ...
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="{{ route('second', ['blogs', 'single']) }}"><img class="br-8 w-100"
                                        src="/img/blog/vl-blog-3.2.png" alt="" /></a>
                                <div class="vl-single-blog-tag">
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a
                                        href="{{ route('second', ['blogs', 'single']) }}">Empowering Your Business with
                                        <br /> Cutting-Edge Insights</a></h3>
                                <a href="{{ route('second', ['blogs', 'single']) }}" class="vl-readmore">Learn More
                                    <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="vl-single-blog-item vl-single-blog-item-3 mb-30 aos-init aos-animate"
                            ...
                            <div class="vl-single-blog-img p-relative fix br-8">
                                <a href="{{ route('second', ['blogs', 'single']) }}"><img class="br-8 w-100"
                                        src="/img/blog/vl-blog-3.3.png" alt="" /></a>
                                <div class="vl-single-blog-tag">
                                    <a href="#">It Service</a>
                                </div>
                            </div>
                            ...
                            <div class="vl-single-blog-content vl-single-blog-content-3">
                                <h3 class="vl-single-blog-title vl-blc-text-4 pt-16 pb-24"><a
                                        href="{{ route('second', ['blogs', 'single']) }}">Transform Your Business with
                                        <br /> Innovative Solutions</a></h3>
                                <a href="{{ route('second', ['blogs', 'single']) }}" class="vl-readmore">Learn More
                                    <span><i class="fa-regular fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-30">
                            <div class="vl-footer-widget-1">
                                <div class="vl-footer-logo">
                                    <a href="{{ route('any', 'index') }}"><img src="/img/logo/vl-logo-3.2.png"
                                            alt="" /></a>
                                </div>
                                <div class="vl-footer-content vl-footer-content-3">
                                    <p class="pt-16 pb-32">
                                        We foster a culture of teamwork & <br /> creative problem-solving to deliver <br />
