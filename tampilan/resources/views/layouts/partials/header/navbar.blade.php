                            ...
                            <ul>
                                ...
                                <li class="has-dropdown">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="{{ route('prodi.d3ak') }}">D3 Akuntansi</a></li>
                                        <li><a href="{{ route('prodi.d4bd') }}">D4 Bisnis Digital</a></li>
                                        <li><a href="{{ route('prodi.d4trpl') }}">D4 Teknologi Rekayasa Perangkat Lunak</a></li>
                                    </ul>
                                </li>
                                <li class="has-dropdown">
