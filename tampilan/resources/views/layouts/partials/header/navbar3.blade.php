            ...
            <div class="row align-items-center">
                                                    ...
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <a href="{{ route('any', 'index') }}" target="_blank"
                                                                class="thme-btn3">Multi Page<span><i
                                                                        class="fa-regular fa-arrow-right"></i></span></a>
                                                            <a href="{{ route('second', ['single', 'index-1']) }}"
                                                                target="_blank" class="thme-btn3 mt-20">Single
                                                                Page<span><i
                                                                        class="fa-regular fa-arrow-right"></i></span></a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="vl-home-thumb fix p-relative z-index-1">
                                                        ...
                                                        <div class="vl-home-btn">
                                                            <a href="{{ route('second', ['demo', 'index2']) }}"
                                                                target="_blank" class="thme-btn3">Multi Page<span><i
                                                                        class="fa-regular fa-arrow-right"></i></span></a>
                ...
                <div class="col-lg-3 col-md-6 col-6">
                    <div class="vl-hero-btn-3 d-none d-lg-block text-lg-end fl-right">
                        <a href="" class="vl-btn-3">GET STARTED<span><i
                                    class="fa-regular fa-arrow-right"></i></span></a>
                    </div>
