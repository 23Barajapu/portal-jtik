    ...
    <div class="container vl-header-bg-4">
      <div class="row align-items-center">
        <div class="col-lg-2 col-md-6 col-6">
          <div class="vl-logo">
            <a href="{{ route('second', ['single', 'index-1']) }}"><img src="/img/logo/vl-logo-1.1.png" alt="" /></a>
          </div>
        </div>
  ...
  <div class="vl-offcanvas-wrapper">
    <div class="vl-offcanvas-header d-flex justify-content-between align-items-center mb-50">
      <div class="vl-offcanvas-logo">
        <a href="{{ route('any' , 'index') }}"><img src="/img/logo/vl-footer-logo-4.2.png" alt="" /></a>
      </div>
    ...
    <div class="vl-offcanvas-btnm text-center mb-30">
      <div class="vl-herobtn vl-aboutbtn w-100 vl-upper">
        <a href="{{ route('second', ['pages', 'contact']) }}" class="theme-btn theme-btn2">get started<span><i class="fa-regular fa-arrow-right"></i></span></a>
      </div>
    </div>
