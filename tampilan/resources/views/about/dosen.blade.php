                ...
                @foreach ($dosens as $dosen)
                    <div class="col-md-3 col-6 mb-4">
                        <div class="vl-team-sin text-center">
                            <img src="@if($dosen->foto) @if(str_starts_with($dosen->foto, 'data:image')) {{ $dosen->foto }} @else {{ asset('storage/foto_dosen/' . $dosen->foto) }} @endif @else /img/placeholder-dosen1.png @endif"
