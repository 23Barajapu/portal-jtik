                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('jabatan') is-invalid @enderror"
                            ...
                            <option value="Ketua Jurusan" {{ old('jabatan', $dosen->jabatan) == 'Ketua Jurusan' ? 'selected' : '' }}>Ketua Jurusan</option>
                            <option value="Sekretaris Jurusan" {{ old('jabatan', $dosen->jabatan) == 'Sekretaris Jurusan' ? 'selected' : '' }}>Sekretaris Jurusan</option>
                            <option value="Kaprodi SI" {{ old('jabatan', $dosen->jabatan) == 'Kaprodi SI' ? 'selected' : '' }}>Kaprodi SI</option>
                            <option value="Kaprodi TRPL" {{ old('jabatan', $dosen->jabatan) == 'Kaprodi TRPL' ? 'selected' : '' }}>Kaprodi TRPL</option>
                            <option value="Dosen" {{ old('jabatan', $dosen->jabatan) == 'Dosen' ? 'selected' : '' }}>Dosen</option>
                            <option value="Ka Lab MDI" {{ old('jabatan', $dosen->jabatan) == 'Ka Lab MDI' ? 'selected' : '' }}>Ka Lab MDI</option>
                            <option value="Ka Lab JARKOM" {{ old('jabatan', $dosen->jabatan) == 'Ka Lab JARKOM' ? 'selected' : '' }}>Ka Lab JARKOM</option>
                            <option value="Ka Lab RPL" {{ old('jabatan', $dosen->jabatan) == 'Ka Lab RPL' ? 'selected' : '' }}>Ka Lab RPL</option>
                            <option value="Ka Lab UX" {{ old('jabatan', $dosen->jabatan) == 'Ka Lab UX' ? 'selected' : '' }}>Ka Lab UX</option>
                            <option value="Ka Lab SI" {{ old('jabatan', $dosen->jabatan) == 'Ka Lab SI' ? 'selected' : '' }}>Ka Lab SI</option>
                        </select>
                        @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('prodi') is-invalid @enderror"
                            ...
                            <option value="SI" {{ old('prodi', $dosen->prodi) == 'SI' ? 'selected' : '' }}>Sistem Informasi (D3)</option>
                            <option value="TRPL" {{ old('prodi', $dosen->prodi) == 'TRPL' ? 'selected' : '' }}>Teknologi Rekayasa Perangkat Lunak (D4)</option>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="preview-content">
                                <h6 class="fw-bold">{{ $dosen->nama }}</h6>
                                @if($dosen->jabatan)
                                    <p class="text-info mb-1"><i class="fas fa-user-tie"></i> {{ $dosen->jabatan }}</p>
                                @endif
                                @if($dosen->prodi)
                                    <p class="text-success mb-1"><i class="fas fa-graduation-cap"></i> {{ $dosen->prodi }}</p>
                                @endif
                                @if($dosen->bidang_keahlian)
                                    <p class="text-muted small"><i class="fas fa-star"></i> {{ $dosen->bidang_keahlian }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
