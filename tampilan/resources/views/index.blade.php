  ...
  <!-- ================= Banner section start ================= -->
    ...
    <div class="row">
        ...
        <div class="vl-herobtn vl-upper">
          <a href={{ route('prodi.index') }} class="theme-btn" style="padding: 12px 32px; font-size:1.1rem; border-radius:32px; font-weight:600;">Lihat Program Studi<span><i class="fa-regular fa-arrow-right"></i></span></a>
        </div>
        </div>
      </div>
      </div>
            ...
            @foreach($dosen_urut as $dosen)
              <div class="vl-team-sin">
                <div class="vl-team-thumb">
                  ...
                  <img class="w-100" src="{{ $dosen->foto ? asset('storage/' . $dosen->foto) : '/img/team/vl-team-4.1.png' }}" alt="{{ $dosen->nama }}" />
