                ...
                <div class="col-lg-10">
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="card-content">
                            ...
                            <ol>
                                <li>1. Menyelenggarakan pendidikan guna menghasilkan lulusan ahli di bidang rekayasa perangkat lunak yang kompetitif, inovatif, mandiri, disiplin, serta mampu bersaing di tingkat nasional maupun global.</li>
                                <li>2. Menghasilkan pengetahuan dan teknologi di bidang kecerdasan buatan dan internet of things melalui penelitian yang terintegrasi dengan kebutuhan masyarakat.</li>
                                <li>3. Menghasilkan pengabdian masyarakat yang berkualitas untuk meningkatkan kompetensi masyarakat, di bidang teknologi rekayasa perangkat lunak.</li>
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="700">
                        ...
                        <div class="card-content">
                            <h3 class="card-title">Daftar Mata Kuliah D4 Teknologi Rekayasa Perangkat Lunak</h3>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\jtik_1.0\tampilan\resources\views/prodi/d4trpl.blade.php ENDPATH**/ ?>