            ...
            <div class="row justify-content-center pt-5 pb-3" style="padding-top: 110px !important;">
                <div class="col-lg-10 text-center text-white">
                    ...
                    <h1 class="vl-section-title vl-section-title-2 pt-16 pb-8"
                        style="color:#fff; text-shadow:0 2px 8px #222;">D3 Sistem Informasi</h1>
                    <hr style="width: 80px; border: 2px solid #fff; margin: 0 auto 24px auto; opacity:0.7;">
                    <h4 class="fw-bold" style="color:#fff; text-shadow:0 2px 8px #222;">Program Studi D3 Sistem Informasi
                        Politeknik Negeri Subang</h4>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <div class="mb-5 text-center">
                        <p class="lead"
                            ...
                            Studi Sistem Informasi dirancang lulusannya memiliki pengetahuan dan keterampilan didalam
                            mendesain dan mengelola sistem informasi.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card shadow-sm p-4 about-card"
                        ...
                        <p>Pada tahun 2030, menjadi salah satu Program Studi terbaik di Bidang Sistem Informasi secara
                    ...
                    <div class="card shadow-sm p-4 about-card"
                        ...
                        <ul>
                            ...
                            <li>3. Melaksanakan kegiatan pengabdian kepada masyarakat di bidang sistem informasi untuk
                            ...
                            <li>4. Mengembangkan kerjasama dengan industri, asosiasi dan institusi, guna menghasilkan mutu
                                lulusan dan sumber daya manusia yang professional, berjiwa wirausaha dan berkarakter.</li>
                        </ul>
                    </div>
                    <div class="card shadow-sm p-4 about-card"
                        style="background:rgba(255,255,255,0.85); border-radius:8px; margin-bottom:24px;">
                        ...
                        <ol>
                            <li>1. Menghasilkan tenaga profesional di bidang sistem informasi yang memiliki sikap dan
                                kemampuan
                                sebagai berikut:
                            ...
                            <li>3. Menghasilkan pengabdian masyarakat yang berkualitas untuk meningkatkan kompetensi
                                masyarakat, di bidang sistem informasi.</li>
                    ...
                    <div class="card shadow-sm p-4 about-card"
                        ...
                        <p>Kompetensi lulusan program studi D3 Sistem Informasi terdiri atas:</p>
                    ...
                    <div class="card shadow-sm p-4 about-card"
                        style="background:rgba(255,255,255,0.85); border-radius:8px; margin-bottom:24px;">
                        <h3 class="mb-3">Daftar Mata Kuliah D-III Sistem Informasi</h3>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\web_jtik\portal-jtik-main\tampilan\resources\views/prodi/d3si.blade.php ENDPATH**/ ?>