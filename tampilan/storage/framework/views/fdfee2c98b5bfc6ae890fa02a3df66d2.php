<?php $__env->startSection('content'); ?>
                    ...
                    <div class="hero-content" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <p class="hero-description lead"
                           style="font-size: 1.2rem; opacity: 0.85; max-width: 800px; margin: 0 auto;">
                            Program Studi Sistem Informasi dirancang lulusannya memiliki pengetahuan dan keterampilan dalam mendesain dan mengelola sistem informasi.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-text">
                                Pada tahun 2030, menjadi salah satu Program Studi terbaik di Bidang Sistem Informasi secara nasional untuk mendukung perkembangan industri.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="card-content">
                            ...
                            <ul>
                                <li>1. Menyelenggarakan proses pembelajaran berkualitas dengan peningkatan berkelanjutan yang relevan dengan kebutuhan pemangku kepentingan dalam bidang sistem informasi;</li>
                                <li>2. Mengembangkan penelitian terapan di bidang sistem informasi.</li>
                                <li>3. Melaksanakan kegiatan pengabdian kepada masyarakat di bidang sistem informasi untuk meningkatkan sumber daya dan kesejahteraan masyarakat.</li>
                                <li>4. Mengembangkan kerjasama dengan industri, asosiasi dan institusi, guna menghasilkan mutu lulusan dan sumber daya manusia yang professional, berjiwa wirausaha dan berkarakter.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="card-content">
                            ...
                            <ol>
                                <li>1. Menghasilkan tenaga profesional di bidang sistem informasi yang memiliki sikap dan kemampuan sebagai berikut:
                                ...
                                <li>2. Menghasilkan penelitian terapan yang inovatif di bidang sistem informasi.</li>
                                <li>3. Menghasilkan pengabdian masyarakat yang berkualitas untuk meningkatkan kompetensi masyarakat, di bidang sistem informasi.</li>
                                <li>4. Menghasilkan hubungan kerja sama yang saling menguntungkan dengan pihak industri, asosiasi dan institusi.</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-text mb-4">
                                Kompetensi lulusan program studi D3 Sistem Informasi terdiri atas:
                            </p>
                            ...
                            <ol type="1">
                                ...
                                <li>10. Mampu melakukan perancangan sistem informasi.</li>
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="700">
                        ...
                        <div class="card-content">
                            <h3 class="card-title">Daftar Mata Kuliah D-III Sistem Informasi</h3>
    ...
    <!-- Styles diselaraskan dengan d3ak -->
    <style>
        /* Hero Section Styles */
        .hero-section {
            position: relative;
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\jtik_1.0\tampilan\resources\views/prodi/d3si.blade.php ENDPATH**/ ?>