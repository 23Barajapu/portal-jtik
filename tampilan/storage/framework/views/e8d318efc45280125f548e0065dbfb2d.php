                        ...
                        <nav class="vl-mobile-menu-active">
                            <ul>
                                ...
                                <li class="has-dropdown">
                                    <a href="<?php echo e(route('about.index')); ?>">About Us <span><i
                                                class="fa-regular fa-angle-down"></i></span></a>
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(route('about.visimisi')); ?>">Visi Misi</a></li>
                                        <li><a href="<?php echo e(route('about.tujuan')); ?>">Tujuan</a></li>
                                        <li><a href="<?php echo e(route('about.sejarah')); ?>">Sejarah</a></li>
                                        <li><a href="<?php echo e(route('about.struktur')); ?>">Struktur Organisasi</a></li>
                                        <li><a href="<?php echo e(route('about.dosen')); ?>">Dosen & Tenaga Kependidikan</a></li>
                                        <li><a href="<?php echo e(route('about.cpl')); ?>">Kompetensi Lulusan</a></li>
                                        <li><a href="<?php echo e(route('about.fasilitas')); ?>">Fasilitas</a></li>
                                    </ul>
                                </li>
                                <li class="has-dropdown">
                                    <a href="<?php echo e(route('prodi.index')); ?>">Program Studi <span><i
                                                class="fa-regular fa-angle-down"></i></span></a>
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(route('prodi.d3si')); ?>">D3 Sistem Informasi</a></li>
                                        <li><a href="<?php echo e(route('prodi.d3ak')); ?>">D3 Akuntansi</a></li>
                                        <li><a href="<?php echo e(route('prodi.d4bd')); ?>">D4 Bisnis Digital</a></li>
                                        <li><a href="<?php echo e(route('prodi.d4trpl')); ?>">D4 Teknologi Rekayasa Perangkat Lunak</a></li>
                                    </ul>
                                </li>
                                <li class="has-dropdown">
                                    <a href="<?php echo e(route('program.index')); ?>">Program <span><i
                                                class="fa-regular fa-angle-down"></i></span></a>
                                    <ul class="sub-menu">
    ...
    <div class="vl-offcanvas-wrapper">
        ...
        <div class="vl-offcanvas-btnm text-center mb-30">
            <div class="vl-herobtn vl-aboutbtn w-100 vl-upper">
                <a href="<?php echo e(route('second', ['pages', 'contact'])); ?>" class="theme-btn theme-btn2">get started<span><i
...
<!-- offcanvas menu end -->
<!-- ================= Header section End ================= -->
<?php /**PATH C:\laragon\www\jtik_1.0\tampilan\resources\views/layouts/partials/header/navbar.blade.php ENDPATH**/ ?>