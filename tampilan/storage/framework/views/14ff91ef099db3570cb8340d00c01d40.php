                ...
                <div class="col-lg-10">
                    ...
                    <div class="modern-card mb-5" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-text mb-3">Kompetensi lulusan program studi D4 Bisnis Digital terdiri atas:</p>
                            <h5 class="competency-title"><i class="fas fa-star"></i> Kompetensi utama lulusan:</h5>
                            ...
                            <h5 class="competency-title"><i class="fas fa-handshake"></i> Kompetensi pendukung lulusan:</h5>
                            <ol type="1" class="mb-3">
                            ...
                            <h5 class="competency-title"><i class="fas fa-cogs"></i> Kompetensi lainnya:</h5>
                            ...
                            <div class="lecturer-grid">
                                <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="lecturer-item">
                                        <div class="lecturer-avatar"><i class="fas fa-user"></i></div>
                        ...
                        <div class="card-content">
                            ...
                            <div class="table-container">
                                <table class="modern-table">
                                    <thead>
                                    <tr><th>No</th><th>Kode Mata Kuliah</th><th>Nama Matakuliah</th></tr>
                                    </thead>
                                    <tbody>
                                    <?php $no = 1; ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\jtik_1.0\tampilan\resources\views/prodi/d4bd.blade.php ENDPATH**/ ?>