        ...
        <div class="row">
            <div class="col-12">
                <div class="vl-breadcrumb-content text-center">
                    <h2 class="vl-breadcrumb-title"><?php echo e(Str::limit($berita->judul, 60)); ?></h2>
                    <ul class="vl-breadcrumb-list justify-content-center">
                        <li><a href="<?php echo e(route('root')); ?>">Beranda</a></li>
                        <li><a href="<?php echo e(route('root')); ?>#berita">Berita</a></li>
                        <li class="active"><?php echo e(Str::limit($berita->judul, 30)); ?></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="vl-blog-single-content bg-white rounded-3 shadow-sm p-4">
                    ...
                    <div class="vl-blog-single-header mb-40">
                        <div class="vl-blog-meta-top mb-3">
                            ...
                            <span class="badge fs-6 px-3 py-2" style="background-color: #000e5f;"><?php echo e($berita->kategori->nama); ?></span>
                            <?php endif; ?>
                            <span class="text-muted ms-3">
                                <i class="fas fa-calendar-alt me-2"></i>
                                <?php echo e($berita->tanggal->format('d F Y')); ?>

                            </span>
                        </div>
                        <h1 class="vl-blog-single-title mb-20"><?php echo e($berita->judul); ?></h1>
                    </div>
                    ...
                    <div class="vl-blog-single-content-text">
                        ...
                        <div class="vl-blog-summary mb-40">
                            <div class="vl-summary-box">
                                ...
                                <p class="lead mb-0"><?php echo e($berita->ringkasan); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="vl-blog-single-footer mt-50 pt-30 border-top">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-md-end">
                                <a href="<?php echo e(route('root')); ?>" class="btn btn-primary">
                ...
                <div class="vl-blog-sidebar">
                    ...
                    <div class="vl-sidebar-widget mb-40">
                        ...
                        <div class="vl-sidebar-widget-content">
                            <?php $__currentLoopData = $beritaTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $beritaLain): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="vl-sidebar-post-item d-flex align-items-center mb-20">
                                <div class="vl-sidebar-post-image me-3">
                                    <?php if($beritaLain->gambar): ?>
                                        <?php if(str_starts_with($beritaLain->gambar, 'data:image')): ?>
                                            <img src="<?php echo e($beritaLain->gambar); ?>"
                                                 alt="<?php echo e($beritaLain->judul); ?>"
                                                 style="width: 70px; height: 70px; object-fit: cover; border-radius: 8px;">
                                        <?php else: ?>
                                            <img src="/storage/berita/<?php echo e($beritaLain->gambar); ?>"
                                                 alt="<?php echo e($beritaLain->judul); ?>"
                                                 style="width: 70px; height: 70px; object-fit: cover; border-radius: 8px;">
                                        <?php endif; ?>
                                    <?php else: ?>
                                ...
                                <div class="vl-sidebar-post-content">
                                    <h6 class="vl-sidebar-post-title">
                                        <a href="<?php echo e(route('berita.detail', $beritaLain->id)); ?>">
                                            <?php echo e(Str::limit($beritaLain->judul, 50)); ?>

                                        </a>
                                    </h6>
                                    <small class="text-muted">
                                        <i class="fas fa-calendar-alt me-1"></i>
                                        <?php echo e($beritaLain->tanggal->format('d/m/Y')); ?>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\web_jtik\portal-jtik-main\tampilan\resources\views/berita/detail.blade.php ENDPATH**/ ?>