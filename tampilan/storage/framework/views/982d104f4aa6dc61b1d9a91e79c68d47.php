                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="vl-about-choose-content">
                                    ...
                                    <div class="vl-about-inner-btn">
                                        <a href="<?php echo e(route('second', ['services', 'service'])); ?>" class="vl-iner-btn">Learn
        ...
        <div class="container p-relative">
            ...
            <div class="row g-4 justify-content-center mb-5">
                <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 col-6" data-aos="zoom-in" data-aos-delay="<?php echo e(200 + $loop->index * 100); ?>">
                        <div class="card border-0 shadow-sm text-center p-3 h-100" style="border-radius:16px;">
                            <img src="<?php if($dosen->foto): ?> <?php if(str_starts_with($dosen->foto, 'data:image')): ?> <?php echo e($dosen->foto); ?> <?php else: ?> <?php echo e(asset('storage/foto_dosen/' . $dosen->foto)); ?> <?php endif; ?> <?php else: ?> /img/placeholder-dosen1.png <?php endif; ?>" alt="<?php echo e($dosen->nama); ?>"
                                class="rounded-circle mx-auto mb-3 shadow"
                                style="width:110px; height:110px; object-fit:cover;">
                            <h5 class="mb-1"><?php echo e($dosen->nama); ?></h5>
                            <span class="text-muted small"><?php echo e($dosen->jabatan); ?></span>
                        </div>
                    </div>
            ...
            <div class="row g-4 justify-content-center">
                <?php $__currentLoopData = $tendiks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tendik): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 col-6" data-aos="zoom-in" data-aos-delay="<?php echo e(200 + $loop->index * 100); ?>">
                        <div class="card border-0 shadow-sm text-center p-3 h-100" style="border-radius:16px;">
                            <img src="<?php echo e(asset('storage/foto_tendik/' . $tendik->foto)); ?>" alt="<?php echo e($tendik->nama); ?>"
                                class="rounded-circle mx-auto mb-3 shadow"
                                style="width:110px; height:110px; object-fit:cover;">
                            <h5 class="mb-1"><?php echo e($tendik->nama); ?></h5>
                            <span class="text-muted small"><?php echo e($tendik->jabatan); ?></span>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('layouts.landing', ['title' => 'O-Tech || About'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\web_jtik\portal-jtik-main\tampilan\resources\views/pages/about.blade.php ENDPATH**/ ?>