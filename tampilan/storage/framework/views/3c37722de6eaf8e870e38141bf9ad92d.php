                ...
                <?php $__currentLoopData = $dosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dosen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 col-6 mb-4">
                        <div class="vl-team-sin text-center">
                            <img src="<?php if($dosen->foto): ?> <?php if(str_starts_with($dosen->foto, 'data:image')): ?> <?php echo e($dosen->foto); ?> <?php else: ?> <?php echo e(asset('storage/foto_dosen/' . $dosen->foto)); ?> <?php endif; ?> <?php else: ?> /img/placeholder-dosen1.png <?php endif; ?>"
                                alt="<?php echo e($dosen->nama); ?>" class="w-100"
                                style="border-radius:16px; object-fit:cover; max-width:160px; max-height:160px; margin:auto;" />
                            <h4 class="title mt-3"><?php echo e($dosen->nama); ?></h4>
                            <span>Dosen</span>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\web_jtik\portal-jtik-main\tampilan\resources\views/about/dosen.blade.php ENDPATH**/ ?>