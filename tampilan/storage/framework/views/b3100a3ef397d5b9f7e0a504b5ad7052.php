...
unset($__errorArgs, $__bag); ?>"
                               id="judul" name="judul" value="<?php echo e(old('judul')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                  ...
                                  placeholder="Ringkasan singkat berita (opsional)"><?php echo e(old('ringkasan')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                  id="isi" name="isi" rows="15" required><?php echo e(old('isi')); ?></textarea>
                        <?php $__errorArgs = ['isi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\web_jtik\portal-jtik-main\tampilan\resources\views/admin/berita/create.blade.php ENDPATH**/ ?>