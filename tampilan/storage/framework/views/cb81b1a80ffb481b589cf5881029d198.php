                    ...
                    <div class="hero-content text-white">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb" style="background: transparent; color: rgba(255,255,255,0.8);">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('any', 'index')); ?>" class="text-white-50">Home</a></li>
                        ...
                        <div class="prodi-card-image">
                            ...
                            <div class="prodi-card-overlay">
                                <div class="prodi-card-content">
                                    ...
                                    <a href="<?php echo e(url('prodi/d3si')); ?>" class="btn btn-primary">Detail D3SI</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="prodi-card-image">
                            ...
                            <div class="prodi-card-overlay">
                                <div class="prodi-card-content">
                                    ...
                                    <a href="<?php echo e(url('prodi/d3ak')); ?>" class="btn btn-warning">Detail D3AK</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="prodi-card-image">
                            ...
                            <div class="prodi-card-overlay">
                                <div class="prodi-card-content">
                                    ...
                                    <a href="<?php echo e(url('prodi/d4trpl')); ?>" class="btn btn-success">Detail D4TRPL</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="prodi-card-image">
                            ...
                            <div class="prodi-card-overlay">
                                <div class="prodi-card-content">
                                    ...
                                    <a href="<?php echo e(url('prodi/d4bd')); ?>" class="btn btn-info">Detail D4BD</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.landing', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\jtik_1.0\tampilan\resources\views/prodi/index.blade.php ENDPATH**/ ?>